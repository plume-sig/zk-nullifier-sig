...
export function bigIntToRegisters(value: bigint, bits_per_register: bigint, register_count: bigint): bigint[] {
...
export function registersToBigint(registers: bigint[], bits_per_register: bigint): bigint {
    const register_size = 2n ** bits_per_register;
    let value = 0n;
    let e = 1n;
