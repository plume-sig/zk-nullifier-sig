...
export function computeAllInputs(message, secret_key, _r, _version) {
    ...
    var ptr2 = isLikeNone(_r) ? 0 : passStringToWasm0(_r, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.computeAllInputs(ptr0, len0, ptr1, len1, ptr2, len2, isLikeNone(_version) ? 0xFFFFFF : _version);
